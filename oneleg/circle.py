...
async def controller(odrive1, odrive2, odrive3):
    ...
    odrive1.set_traj_vel_limit(0.001)  # Example velocity limit
    await asyncio.sleep(0.1)
    odrive1.set_traj_accel_limits(0.001, 0.001)  # Example accel/decel limits
    await asyncio.sleep(0.1)

    # Set trajectory limits for smooth motion for odrive2
    odrive2.set_traj_vel_limit(0.001)  # Example velocity limit
    await asyncio.sleep(0.1)
    odrive2.set_traj_accel_limits(0.001, 0.001)  # Example accel/decel limit
    await asyncio.sleep(0.1)
